...
export const leadership: Record<string, {
  ...
  },
  {
      ...
      bio: "I am a junior Computer Engineering major at LMU, minoring in Bioethics. As a first-generation Latina in STEM, I am interested in using technology to create meaningful and ethical impact, particularly in areas such as healthcare and artificial intelligence. I am especially drawn to the intersection of engineering and ethics, and hope to use my education to address real challenges while advocating for more inclusive and equitable spaces in STEM. Being part of SHPE has provided me with a strong sense of community and support, connecting me with peers who continue to motivate me to grow both academically and professionally.",
    ...
    },    
    {
      ...
      bio: "I am a Junior Mechanical Engineering student at LMU who believes in using engineering and leadership to create a meaningful impact on the community around me. I am committed to mentorship, collaboration, and creating inclusive spaces within STEM. Growing up in Los Angeles, I am passionate about giving back to my community and expanding access to STEM opportunities.",
    ...
    },
    {
      ...
      bio: "I’m Alex Morales. I am the Academic Chair for SHPE. I am originally from Mexico, but I currently live in Florida. I love playing sports, particularly golf. ",
...
export const interns: Record<string, {
  ...
  interns2027: [
    { id: "tbd-intern1", role: "Intern", name: "TBD", major: "TBD", year: "TBD", photo: "", funPhoto: "", bio: "TBD", email: "", isPlaceholder: true },
    { id: "tbd-intern2", role: "Intern", name: "TBD", major: "TBD", year: "TBD", photo: "", funPhoto: "", bio: "TBD", email: "", isPlaceholder: true },
    { id: "tbd-intern3", role: "Intern", name: "TBD", major: "TBD", year: "TBD", photo: "", funPhoto: "", bio: "TBD", email: "", isPlaceholder: true },
    { id: "tbd-intern4", role: "Intern", name: "TBD", major: "TBD", year: "TBD", photo: "", funPhoto: "", bio: "TBD", email: "", isPlaceholder: true },
  ],
  interns2026: [
  {
    id: "azul",
