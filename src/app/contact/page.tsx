            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4 p-5 rounded-xl bg-card border border-border">
                  <div className="w-12 h-12 flex-shrink-0 rounded-xl bg-hero-gradient flex items-center justify-center">
                ...
                {/* Meeting Times */}
                <div className="flex gap-4 p-5 rounded-xl bg-card border border-border">
                  <div className="w-12 h-12 flex-shrink-0 rounded-xl bg-gold-gradient flex items-center justify-center">
              ...
              <div className="mt-8 p-6 rounded-2xl bg-hero-gradient text-primary-foreground">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="flex items-center gap-2 px-4 py-3 rounded-xl bg-primary-foreground/10 hover:bg-primary-foreground/20 transition-all duration-300"
                  >
                    <Instagram size={20} />
